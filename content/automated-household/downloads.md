...
description: "Free field guides from Christa Burger's Automated Household workshops: the full deck, AI use-case finders, agent skill builder, and the household AI system builder."
downloads:
...
These are the handouts from my Automated Household workshops, exactly as I give them in person. They live in the vault below — one email opens all five, instantly. No drip sequence, no upsell maze, no "lesson 4 of 12." I'm a governance person; I believe in honest exchanges. You get the guides; I get to write to you occasionally.
