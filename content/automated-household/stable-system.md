---
title: "The Stable System"
layout: "prose"
eyebrow: "The Automated Household"
lead: "A team of specialized AI agents, working together. With portraits."
description: "The Stable System: Christa Burger's household AI architecture — specialized agents with identity, organized into stables by workstream, complete with pony portraits and a Fern Gully console."
cta_title: "Ready to build your own stable?"
cta_text: "You don't need ponies. You need one agent with one job — and a reason to keep going. Start with the walkthrough or grab the free field guides."
cta_url: "/automated-household/build-your-own/"
cta_label: "Build Your Own"
---
...
<figure class="arch-figure">
  <a href="/images/household-agents-architecture.jpg" target="_blank" rel="noopener">
    <img src="/images/household-agents-architecture.jpg" alt="The Household Agents Architecture — a hand-illustrated map of the Stable System: Caleb the steward agent, specialist pony agents for inventory, rhythm, meals, procurement, and audit, four store scouts, a decision engine, and the flows between them.">
  </a>
  <figcaption>The Household Agents Architecture. Click to view full size. Inputs flow to specialists, specialists feed the decision engine, the steward produces one daily briefing — and the audit loop keeps everyone improving.</figcaption>
</figure>
...
<div class="pony-grid">
  <figure class="pony-card">
    <img src="/images/pony-rosie.jpg" alt="Rosie (Rose-Luck) — a white pony with rose-red mane, framed in an illustrated woodland border. Role: Source of Truth.">
    <figcaption><strong>Rosie (Rose-Luck)</strong><br>Head Committee — Source of Truth. Gathers signals, keeps the master list, routes trusted updates across the wood.</figcaption>
  </figure>
  <figure class="pony-card">
    <img src="/images/pony-cadence.jpg" alt="Cadence (Powder-Snowflakes) — a lavender unicorn with rainbow mane. Role: Rhythm Keeper.">
    <figcaption><strong>Cadence</strong><br>Head Committee — Rhythm Keeper. Holds the daily, weekly, and monthly beat so the others move in time.</figcaption>
  </figure>
  <figure class="pony-card">
    <img src="/images/pony-skydance.jpg" alt="SkyDance — a golden pony with butterfly markings. Role: Meal-Rhythm Filter.">
    <figcaption><strong>SkyDance</strong><br>Harvest Stump — Meal-Rhythm Filter. Turns timing plus deals into a practical meal rhythm for the week.</figcaption>
  </figure>
</div>

<div class="pony-grid pony-grid--two">
  <figure class="pony-card">
    <img src="/images/pony-scout-ks.jpg" alt="Scout-KS — a pony in a King Soopers cap and scout scarf, holding a map. Role: grocery deal scout.">
    <figcaption><strong>Scout-KS</strong><br>Store Scout. Finds grocery deals and pantry wins at King Soopers, then passes them to SkyDance, Cotton Candy, and Rosie.</figcaption>
  </figure>
  <figure class="pony-card">
    <img src="/images/pony-scout-amazon.jpg" alt="Scout-Amazon — a white pony with black and orange mane wearing delivery saddlebags. Role: snack-deal scout.">
    <figcaption><strong>Scout-Amazon</strong><br>Store Scout. Watches pantry and snack deals, feeds the best finds into the cart. I order from emails this pony sends me.</figcaption>
  </figure>
</div>
...
<figure class="arch-figure">
  <img src="/images/fern-gully-console.jpg" alt="The Fern Gully Stable Console — a custom interface where each stable appears as a woodland stump with its resident agents listed inside.">
  <figcaption>The Fern Gully Stable Console. Highly customized, entirely mine — and proof that ANYTHING is possible if you get creative and have fun with it.</figcaption>
</figure>
